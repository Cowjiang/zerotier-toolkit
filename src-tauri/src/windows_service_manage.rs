...
pub(crate) mod api {
    ...
    impl WindowsServiceManage {
        ...
        pub fn transform_start_type(&self, string: String) -> StartType {
        ...
        fn get_service_winapi(
            ...
            let sc_manager =
                unsafe { OpenSCManagerA(ptr::null(), ptr::null(), SC_MANAGER_CONNECT) };
            ...
            let service =
                unsafe { OpenServiceA(sc_manager, service_name.as_ptr(), dw_desired_access) };
            if service.is_null() {
                unsafe { CloseServiceHandle(sc_manager) };
                return Err(Error::new(
                    Other,
        ...
        pub(crate) fn register_state_listener(&mut self) {
            ...
            thread::spawn(move || {
                ...
                let service_result =
                    Self::get_service_winapi(service_name.clone(), SERVICE_ALL_ACCESS);
                if service_result.is_err() {
                ...
                let (sc_manager, service) = service_result.ok().unwrap();
                let event_handler =
                    unsafe { CreateEventA(ptr::null_mut(), TRUE, FALSE, ptr::null()) };
                ...
                loop {
                    ...
                    let wait_result =
                        unsafe { WaitForSingleObjectEx(event_handler, 99999999, TRUE) };
    ...
    mod tests {
        ...
        use crate::windows_service_manage::api::StartType::AutoStart;
        use crate::windows_service_manage::api::WindowsServiceManage;
