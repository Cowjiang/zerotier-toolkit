...
use log::debug;
use tauri::{App, AppHandle, Event, Manager, RunEvent, Window, WindowBuilder, WindowEvent};
...
use crate::configuration::{GENERAL_ENABLE_TRAY, GENERAL_MINIMIZE_TO_TRAY, get_config, get_config_dy_def, init_config, put_config_command};
