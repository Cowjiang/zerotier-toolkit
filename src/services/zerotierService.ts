...
const joinOrUpdateNetwork = (networkId: string) =>
  zerotierService.post<Network, Network>(`/network/${networkId}`)

const leaveNetwork = (networkId: string) =>
  zerotierService.delete(`/network/${networkId}`)
