...
export const InterrogationIcon = (props: Props) => {
  return (
    <IconWrapper {...props}>
      <path
        fill="currentColor"
...
export const FlaskIcon = (props: Props) => {
  return (
    <IconWrapper {...props}>
      <path
        fill="currentColor"
        d="m17.929,9.891c-.59-.56-.929-1.351-.929-2.17V2h1c.553,0,1-.448,1-1s-.447-1-1-1H6c-.553,0-1,.448-1,1s.447,1,1,1h1v5.721c0,.819-.339,1.61-.929,2.169-1.281,1.214-3.052,3.066-4.35,5.11h17.279c.553,0,1,.448,1,1s-.447,1-1,1H.653c-.406.956-.653,1.922-.653,2.857,0,.862.23,1.648.685,2.334.747,1.132,2.059,1.809,3.508,1.809h15.615c1.449,0,2.761-.676,3.507-1.808.455-.688.686-1.473.686-2.335,0-3.667-3.804-7.818-6.071-9.966Z"
      />
    </IconWrapper>
  )
}
...
export const TagsIcon = (props: Props) => {
  return (
    <IconWrapper {...props}>
      <path
        fill="currentColor"
